...
import 'signuppage1_model.dart';
export 'signuppage1_model.dart';

class Signuppage1Widget extends StatefulWidget {
  const Signuppage1Widget({super.key});
...
class _Signuppage1WidgetState extends State<Signuppage1Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Signuppage1Model());
    ...
    _model.birthMonthController ??= TextEditingController();
    _model.birthMonthFocusNode ??= FocusNode();
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 12.0, 0.0, 24.0),
                                  child: Text(
                                    'Before you create an account, fill these informations',
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 370.0,
                                    child: TextFormField(
                                      controller: _model.birthMonthController,
                                      focusNode: _model.birthMonthFocusNode,
                                      autofocus: true,
                                      autofillHints: const [
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      setState(() {
                                        ...
                                        FFAppState().birthYear = int.parse(
                                            _model.birthYearController.text);
                                        FFAppState().birthMonth = int.parse(
                                            _model.birthMonthController.text);
                                        FFAppState().birthDay = int.parse(
                                            _model.birthDayController.text);
                                      });

                                      context.pushNamed('signuppage2');
                                    },
                                    text: 'Next\n',
