...
import 'signuppage2_model.dart';
export 'signuppage2_model.dart';
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.result =
                                          await UsersGroup.signUpCall.call(
                                        username: FFAppState().name,
                                        email:
                                            _model.emailAddressController.text,
                                        password:
                                            _model.passwordController.text,
                                        birthYear: FFAppState().birthYear,
                                        birthMonth: FFAppState().birthMonth,
                                        birthDay: FFAppState().birthDay,
                                      );
                                      if ((_model.result?.succeeded ?? true)) {
                                        setState(() {
                                          FFAppState().email =
                                              SignUpResponseStruct.fromMap(
                                                      (_model.result
                                                              ?.jsonBody ??
                                                          ''))
                                                  .result
